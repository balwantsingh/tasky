<div>
    ...
    @if($wantsToViewTask)
        <!-- Modal View Task-->
        <div wire:ignore.self class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="viewTask"
            tabindex="-1" aria-labelledby="viewTaskModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-fullscreen modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="border-bottom" style="padding:10px 0 0 25px;">
                        <button wire:click.prevent="$emit('closeButton')" type="button" class="btn-close"
                            data-bs-dismiss="modal" aria-label="Close"
                            style="float:right;margin:10px 20px 0 0;"></button>
                        <img class="profile-xs float-sm-start border"
                            src="{{ $taskView->assignTo->userProfile() }}">
